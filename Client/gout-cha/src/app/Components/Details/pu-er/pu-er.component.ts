...
@Component({
  ...
  template: `
    ...
    <p class="text-c1d1d1b text-center text-xl">
      De plus en plus emblématiques des amateurs de thé, les thés Pu'er sont
      encore source de nombreux mystères. <br />Essayons ici de mieux comprendre
      qui sont ces thés afin de mieux savoir les choisir.
    </p>

    <!-- Chapter 1 section -->
    <div class="px-20">
      <app-chapter *ngFor="let chapter of chapters" [chapter]="chapter" />
    </div>
